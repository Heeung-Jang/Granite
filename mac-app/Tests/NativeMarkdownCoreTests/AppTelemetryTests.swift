...
func telemetrySchemaDefinesAllowedAndDisallowedFields() {
    ...
    #expect(schema.rejectsRawField("promptText"))
    #expect(schema.rejectsRawField("chunkText"))
    #expect(schema.rejectsRawField("summaryText"))
    #expect(schema.rejectsRawField("modelResponse"))
    #expect(schema.rejectsRawField("contentHash"))
