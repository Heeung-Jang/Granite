...
아래 예시는 공개 문서용으로 생성한 데모 vault만 사용합니다. Granite에서 vault를 탐색하고, 검색 패널로 전환한 뒤, 로컬 인덱스에서 검색 결과를 확인하는 흐름입니다.

<p align="center">
  <img src="assets/readme/granite-workflow.gif" alt="로컬 데모 vault, 검색 패널, 로컬 검색 결과를 보여주는 Granite 사용 흐름" width="900" />
</p>
...
6. 왼쪽 ribbon의 graph 아이콘 또는 `Command-G`로 whole-vault graph를 엽니다.
